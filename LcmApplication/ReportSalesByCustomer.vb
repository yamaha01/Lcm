...
Public Class ReportSalesByCustomer
    ...
    Private Sub print()
        ...
        Dim sql As String
        Try
            sql = "select nama_customer, total_order from sales_payment where payment_date BETWEEN @startDate AND @endDate group by nama_customer "
            ...
            myReport.Load("D:\Personal\IT_Solution\Lcm\LcmApplication\SalesByCustomer.rpt")
